...
/**
 * Busca opções de alocação para uma nova reserva utilizando a API Dike
 * (endpoint /api/allocate).
 *
 * Recebe os dados da nova reserva (estrutura flat), coleta salas e
 * reservas existentes da intranet e envia ao serviço Dike.
 *
 * @param array $new_reservation Dados da nova reserva (estrutura flat).
 *                               Ex.: ['title' => '...', 'date' => '2026-03-02',
 *                               'start_time' => '14:00', 'end_time' => '16:00',
 *                               'capacity' => 40]
 * @param int   $limit_moves     Limite de remanejamentos permitidos (padrão: 3).
 *
...
function dike_allocate_reservation($new_reservation, $limit_moves = 3)
{
	...
	// 2. Coletar reservas existentes
	$existing_reservations_raw = intranet_fafar_api_get_submissions_by_object_name(
		'reservation',
		[],
	...
	if (!empty($existing_reservations_raw) && !empty($existing_reservations_raw['data'])) {
...
{
	// return array( 'error_msg' => 'Tente novamente mais tarde!' );
