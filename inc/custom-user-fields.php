...
<!-- Extras Pessoais -->
    ...
    <table class="form-table">
        <tr>
            ...
            <td>
                <input type="text" name="personal_phone" id="personal_phone" value="<?php echo esc_attr( get_the_author_meta( 'personal_phone', $user->ID ) ); ?>" class="phone" /><br />
            </td>
        </tr>
        <tr>
            <th><label for="personal_birthday"><?php _e( "Data de nascimento", "intranet-astra-child-theme" ); ?></label></th>
            <td>
                <input type="date" name="personal_birthday" id="personal_birthday" value="<?php echo esc_attr( get_the_author_meta( 'personal_birthday', $user->ID ) ); ?>" class="regular-text" /><br />
            </td>
        </tr>
        <tr>
            <th><label for="personal_cpf"><?php _e( "CPF", "intranet-astra-child-theme" ); ?></label></th>
            <td>
                <input type="text" name="personal_cpf" id="personal_cpf" value="<?php echo esc_attr( get_the_author_meta( 'personal_cpf', $user->ID ) ); ?>" class="cpf" /><br />
            </td>
        </tr>
        <tr>
            <th><label for="personal_ufmg_registration"><?php _e( "Matrícula UFMG", "intranet-astra-child-theme" ); ?></label></th>
            <td>
                <input type="text" name="personal_ufmg_registration" id="personal_ufmg_registration" value="<?php echo esc_attr( get_the_author_meta( 'personal_ufmg_registration', $user->ID ) ); ?>" class="regular-text" /><br />
            </td>
        </tr>
        <tr>
            <th><label for="personal_siape"><?php _e( "SIAPE", "intranet-astra-child-theme" ); ?></label></th>
            <td>
                <input type="text" name="personal_siape" id="personal_siape" value="<?php echo esc_attr( get_the_author_meta( 'personal_siape', $user->ID ) ); ?>" class="regular-text siape" /><br />
            </td>
        </tr>
    </table>
...
<!-- Endereço -->
    ...
    <table class="form-table">
        <tr>
            ...
            <td>
                <input type="text" name="address_cep_code" id="address_cep_code" value="<?php echo esc_attr( get_the_author_meta( 'address_cep_code', $user->ID ) ); ?>" class="cep" /><br />
        ...
        <tr>
            ...
            <td>
                <input type="text" name="address_uf" id="address_uf" value="<?php echo esc_attr( get_the_author_meta( 'address_uf', $user->ID ) ); ?>" class="regular-text" /><br />
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td>
                <input type="text" name="address_neighborhood" id="address_neighborhood" value="<?php echo esc_attr( get_the_author_meta( 'address_neighborhood', $user->ID ) ); ?>" class="regular-text" /><br />
            </td>
        </tr>
        <tr>
            <th><label for="address_public_place"><?php _e( "Logradouro", "intranet-astra-child-theme" ); ?></label></th>
            <td>
                <input type="text" name="address_public_place" id="address_public_place" value="<?php echo esc_attr( get_the_author_meta( 'address_public_place', $user->ID ) ); ?>" class="regular-text" /><br />
            </td>
        </tr>
        <tr>
            <th><label for="address_number"><?php _e( "Número", "intranet-astra-child-theme" ); ?></label></th>
            <td>
                <input type="text" name="address_number" id="address_number" value="<?php echo esc_attr( get_the_author_meta( 'address_number', $user->ID ) ); ?>" class="regular-text" /><br />
            </td>
        </tr>
        <tr>
            <th><label for="address_complement"><?php _e( "Complemento", "intranet-astra-child-theme" ); ?></label></th>
            <td>
                <input type="text" name="address_complement" id="address_complement" value="<?php echo esc_attr( get_the_author_meta( 'address_complement', $user->ID ) ); ?>" class="regular-text" /><br />
            </td>
        </tr>
    </table>
...
<!-- Vínculo do Servidor -->
    ...
    <table class="form-table">
        ...
        <tr>
            <th><label for="public_servant_bond_category"><?php _e( "Categoria", "intranet-astra-child-theme" ); ?></label></th>
            <td>
                <?php
        ...
        <tr id="professor_bond_class_levels_row">
            <th><label for="professor_bond_class_levels"><?php _e( "Nível de classe", "intranet-astra-child-theme" ); ?></label></th>
            <td>
                <?php
