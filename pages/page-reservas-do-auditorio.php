...
--> 
        ...
        <ul id="ul_reservation_status_tabs" class="nav nav-tabs ms-0">
            <li class="nav-item">
                <a class="nav-link"
                   href="#" 
                   data-reservation-status="Aguardando aprovação" 
                   data-reservation-status-slug="Aguardando aprovação" 
                   data-reservation-order-by="column:created_at" 
                   data-reservation-order-how="desc">
                    Aguardando aprovação
                    <span class="badge text-bg-light" id="badge_aguardando_aprovacao" data-reservation-status-slug="Aguardando aprovação"></span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link" 
                   href="#" 
                   data-reservation-status="Aguardando técnico" 
                   data-reservation-status-slug="Aguardando técnico" 
                   data-reservation-order-by="column:created_at" 
                   data-reservation-order-how="desc">
                    Aguardando técnico
            ...
            <li class="nav-item">
                <a class="nav-link" 
                   href="#" 
                   data-reservation-status="Aguardando início" 
                   data-reservation-status-slug="Aguardando início" 
                   data-reservation-order-by="json:event_date" 
            ...
            <li class="nav-item">
                <a class="nav-link" 
                   ...
                   data-reservation-status-slug="Finalizada" 
                   data-reservation-order-by="json:event_date" 
                   data-reservation-order-how="desc">
                    Finalizadas
            ...
            <li class="nav-item">
                <a class="nav-link" 
                   href="#" 
                   data-reservation-status="Todas" 
                   data-reservation-status-slug="" 
                   data-reservation-order-by="json:event_date" 
                   data-reservation-order-how="desc">
                    Todas
        ...
        <div class="modal fade" id="intranetFafarReservationDetails" tabindex="-1" aria-labelledby="intranetFafarReservationDetailsLabel" aria-hidden="true">
        ...
        <div class="modal fade" id="intranetFafarSetTechnical" tabindex="-1" aria-labelledby="intranetFafarSetTechnicalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
