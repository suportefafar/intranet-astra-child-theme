	...
	<?php else: ?>
		...
		<form action="/assistente-de-reservas-de-salas?step=2" method="post" class="mb-5" id="form-step-1">
			...
			<div class="form-group mb-3">
				...
				<input type="date" class="form-control" id="date" name="date" min="2024-09-10" aria-required="true"
					required />
			</div>
			<div class="form-group mb-3">
			...
			<div class="form-group mb-3">
				...
				<div class="d-flex gap-3">
					<div class="form-check">
						<input class="form-check-input" type="radio" name="frequency" value="once" id="radioFrequency1"
							checked>
