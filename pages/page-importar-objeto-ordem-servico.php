...
if (
    ...
    foreach ( $old_service_tickets as $old_service_ticket )
    {
        ...
        //     'owner' => get_fafar_new_user_id_by_old_id( $old_service_ticket['solicitante'], $old_users ),
        //     'permissions' => '774',
        ...
        if( $owner === 0 ) {
            $group_owner = get_fafar_new_user_id_by_old_id( $old_service_ticket['solicitante'], $old_users );
        }
...
function get_fafar_sector_by_old_id( $old_id, $old_users ) {
