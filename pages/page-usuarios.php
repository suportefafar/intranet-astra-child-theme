...
-->
	...
	<div id="filters_container" class="d-flex gap-3 mb-2">
		<input type="text" id="input_keyword" class="form-control" placeholder="Pesquise por palavra-chave..."
			aria-label="Nome" aria-describedby="Campo para busca por palavra-chave">
		<input type="text" id="input_place" class="form-control" placeholder="Pesquise por sala...." aria-label="Sala"
			aria-describedby="Campo para busca por sala">
		<?php
