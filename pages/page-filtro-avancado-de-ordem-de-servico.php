    ...
    <form id="search-form">
        <div class='d-flex gap-3'>
            ...
            <div class="mb-3 flex-grow-1">
                ...
                <select class="form-select" id="departament_assigned_to" name="departament_assigned_to" aria-label="Select para Setor">
                    <option value>Todos</option>
        ...
        <div class="d-flex gap-2">
            ...
            <div class="mb-3 flex-grow-1">
                ...
                <select class="form-select" id="assigned_to" name="assigned_to" aria-label="Select para Prestador" disabled>
                    <option value>Todos</option>
                </select>
            </div>
        </div>
